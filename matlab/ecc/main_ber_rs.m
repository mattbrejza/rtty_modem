...
% Section 1
%===============================================================
function main_ber_rs( SNR_start, SNR_delta, SNR_stop, chan, interleave)
%===============================================================
...
if ~(nargin > 4)
    ...
    filename = ['results_rs_',chan,'_',interleave,'_',num2str(SNR_start),'_',num2str(seed),'.mat'];
    ...
    while(keepgoing)
        ...
        while SNR <= SNR_stop
            ...
            if flag    
                ...
                hEnc = comm.RSEncoder;%('CodewordLength',21,'MessageLength',9);
                hDec = comm.RSDecoder;%('CodewordLength',21,'MessageLength',9);
                ...
                while bit_count < 10000% || error_counts(iteration_count) < 10
                    ...
                    %encode
                    encd = step(hEnc, a);                    
                    encb = double(uint16(dec2bin(encd,3))-48);
                    ...
                    errors = sum(sum( double(uint16(dec2bin(data_out,3))-48) ~= double(uint16(dec2bin(a,3))-48)));
