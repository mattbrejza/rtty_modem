...
snr=20;
    ...
    % Generate some noise
    N0 = 1/(10^(snr/10));
    noise1 = sqrt(N0/2)*(randn(1,symbol_count)+1i*randn(1,symbol_count));
    noise2 = sqrt(N0/2)*(randn(1,symbol_count)+1i*randn(1,symbol_count));

    % Generate the received signal
    rx1 = tx1.*channel+noise1;
    rx2 = tx2.*channel+noise2;
    
    % 'turn into' a bpsk signal
    rx = abs(rx2)-abs(rx1);
