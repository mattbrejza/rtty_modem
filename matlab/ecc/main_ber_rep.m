...
% Section 1
%===============================================================
function main_ber_rep( SNR_start, SNR_delta, SNR_stop, repetitions,soft,fading)
%===============================================================
...
filename = ['results_rep',num2str(repetitions),'_',txt,'_',num2str(SNR_start),'_',num2str(seed),'.mat'];
    ...
    while SNR <= SNR_stop
        ...
        if flag
            ...
            while bit_count < 1000000% || error_counts(iteration_count) < 10
                ...
                inter = randperm(frame_length*repetitions);
                ...
                %duplicate
                enc = reshape ( repmat(a,1,repetitions) , 1, frame_length*repetitions);
                ...
                dec =  transpose(reshape ( a_c , frame_length,repetitions));
